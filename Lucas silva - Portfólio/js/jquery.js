...
// Mapa sobre o $ em caso de sobrescrever
if ( window.$ )
	var _$ = window.$;
	
// Mapear o namespace do jQuery para o '$' one
window.$ = jQuery;

// Uma maneira simples de verificar strings HTML ou strings de ID
// (os quais nós otimizamos para)
var quickExpr = /^[^<]*(<(.|\s)+>)[^>]*$|^#(\w+)$/;
...
jQuery.fn = jQuery.prototype = {
	init: function( selector, context ) {
		...
		// Handle HTML strings
			...
			// Verificar uma correspondência e que nenhum contexto foi especificado para #id
